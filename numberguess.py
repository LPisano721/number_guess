...
Author: Luigi Pisano 10/16/20
case study on 269-273

GUI-based version of a number guessing game. Game will indicate if the user's guess is too small, too large or when they win. Also indicate the number of attempts before a win.
"""
